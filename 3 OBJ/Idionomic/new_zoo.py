...
def plot_pos(output, index_col, gsom_map=None, file_name="gsom", file_type=".pdf", 
    ...
    # plt.savefig("gsom_map_revised_skeleton.png")
...
def plot_ind(output, index_col, gsom_map=None, hit_points=None, skeleton_connections=None, junctions=None,
...
if __name__ == '__main__':
    ...
    clusters, segments, remaining_connections, pos_edges, individual_mapping = gsom.separate_clusters(data_training.to_numpy(), max_clusters=7) 
    # Plot GSOM map
    ...
    for i in range(gsom.node_count):
        ...
        # if i in gsom.node_labels['output'].values:
        #     ax.scatter(x, y, c='blue', s=20, marker
    plt.savefig("gsom_map.png")
#################################
#################################
    from collections import Counter
...
#################################
    ...
    plt.savefig("gsom_skeleton_connections.png")
    ...
    plot_ind(output, "Name", gsom_map=gsom, hit_points=clusters[-1], skeleton_connections=remaining_connections,
