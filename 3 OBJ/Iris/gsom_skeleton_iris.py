...
if __name__ == '__main__':
    ...
    # Train GSOM
    # Change the parameters as needed (Specially: Dimension)
    gsom = GSOM(0.83, 4, max_radius=4, initial_node_size=1000)  # Use 0.25 to match paper
    ...
    clusters, segments, skeleton_connections, pos_edges = gsom.separate_clusters(data_training.to_numpy(), max_clusters=3)
...
#################################
    ...
    plt.savefig("gsom_skeleton_iris.pdf")
    plt.show()
